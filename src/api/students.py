...
@router.post("/{student_id}/interests", response_model=StudentSchema)
...
@router.post("/{student_id}/pets", response_model=StudentSchema)
...
@router.post("/{student_id}/lessons", response_model=StudentSchema)
